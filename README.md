...
- get_max_length(): Calculates the maximum length of values in a specified column, ensuring that VARCHAR columns are properly sized.
...
### 2. Working with Pandas DataFrames:
  ...
  - Gained experience in transforming raw data into Pandas DataFrames, making it easier to manipulate, clean, and analyse.
...
### 4. Database Interactions:
  - Strengthened knowledge of connecting to and querying relational databases (PostgreSQL) using SQLAlchemy and psycopg2.
